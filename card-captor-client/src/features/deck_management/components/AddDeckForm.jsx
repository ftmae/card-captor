    ...
    return (
            ...
            <form onSubmit={handleSubmit} className="container bg-white flex-column padding-2 width-responsive" >
                ...
                <div className="flex-row">
                    <button type="submit" className="small-button bg-dark-1 text-white titlecase border-trans" style={{width: '100%'}}>Add</button>
                    <button type="button" className="small-button bg-light-1 text-dark-2 border-dark-2" style={{width: '100%'}} onClick={()=>setAdd(false)}>Cancel</button>
                </div>
            </form>
        </section>
    )
